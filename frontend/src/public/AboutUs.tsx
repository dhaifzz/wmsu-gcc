    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative pt-32 pb-20 overflow-hidden bg-emerald-900">
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-6">About the Center</h1>
          <p className="text-xl text-emerald-100 max-w-3xl mx-auto font-medium">
            The Guidance and Counseling Center at Western Mindanao State University is a vital support unit dedicated to addressing the psychological, emotional, and personal development needs of students and staff.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold">2nd Floor, Executive Building</p>
                    <p className="text-xs text-emerald-100/60 font-medium">WMSU Main Campus, Normal Road</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-100/60 font-medium">8:00 AM - 5:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold leading-tight">Students, Returnees, & Transferees</p>
                  </div>
                </div>
              </div>
            </div>
