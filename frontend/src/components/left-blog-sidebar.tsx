...
const LeftBlogSidebar = ({ user, token, onToggleSave }: LeftBlogSidebarProps) => {
  ...
  if (!user) {
    return (
      <aside className="hidden xl:flex flex-col sticky top-24 h-[calc(100vh-96px)] w-80 bg-emerald-950/10 backdrop-blur-3xl border-r border-white/5 z-20 overflow-y-auto scrollbar-hide">
