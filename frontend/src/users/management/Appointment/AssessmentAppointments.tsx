          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                className={`bg-white border border-slate-200 rounded-lg py-2.5 pl-10 pr-4 text-xs font-bold w-full focus:ring-2 ${theme.focusRing} transition-all outline-none`}
              />
            </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className={theme.bg900}>
                ...
                <th className="px-4 sm:px-6 lg:px-8 py-3.5 sm:py-4 text-[10px] font-black uppercase tracking-widest text-white">Test Name</th>
