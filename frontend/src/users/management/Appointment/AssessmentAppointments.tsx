...
import { ClipboardCheck, Search, Filter, Calendar as CalendarIcon, CheckCircle2, XCircle, MoreHorizontal, FileText } from 'lucide-react';

const AssessmentAppointments = () => {
  const appointments = [
    { id: 1, student: "Maria Clara", level: "High School", grade: "12", track: "Academic", studentId: "2021-00789", time: "08:00 AM - 09:00 AM", date: "May 24, 2024", test: "DASS-21 Test", status: "Approved" },
    { id: 2, student: "Ibarra, Crisostomo", level: "College", course: "BS Psych", studentId: "2021-00999", time: "10:30 AM - 11:30 AM", date: "May 24, 2024", test: "DASS-Y Test", status: "Pending" },
    { id: 3, student: "Salome, Maria", level: "High School", grade: "10", studentId: "2021-00555", time: "01:30 PM - 02:30 PM", date: "May 25, 2024", test: "DASS-21 Test", status: "Pending" },
  ];
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm font-medium mt-1">Review and approve standardized testing sessions.</p>
        </div>
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[10px] font-bold text-slate-500 ml-1">
                        {app.level === 'College' ? app.course : 
                         ['11', '12'].includes(app.grade || '') ? `${app.track} (G${app.grade})` : 
                         `Grade ${app.grade}`}
                      </span>
                    </div>
                  </td>
