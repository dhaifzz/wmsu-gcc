...
const CMS = () => {
  ...
  const applyTheme = (color: string) => {
    ...
    toast.success(`System theme updated to ${color}!`, {
      style: {
        borderRadius: '10px',
        background: '#333',
        color: '#fff',
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[0, 1, 2].map((idx) => (
                        <div key={idx} className="aspect-square bg-slate-100 rounded-2xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 hover:bg-slate-50 hover:border-teal-400 hover:text-teal-500 transition-colors cursor-pointer group">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {homeContent.support.features.map((feature, idx) => (
                      <div key={idx} className="bg-slate-50 p-5 rounded-[2rem] border border-slate-200 space-y-3">
                        ...
                        <div className="h-20 bg-slate-100 rounded-xl border border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 cursor-pointer hover:bg-slate-50 transition-colors">
                          <ImageIcon size={16} className="mb-1" />
                          <span className="text-[8px] font-bold">Change Image</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="h-32 bg-slate-100 rounded-2xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 hover:bg-slate-50 hover:border-teal-400 hover:text-teal-500 transition-colors cursor-pointer group">
                        <ImageIcon size={24} className="mb-2 group-hover:scale-110 transition-transform" />
          ...
          >
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {teamContent.mainCampus.counselors.map((member, idx) => (
                      <div key={idx} className="bg-slate-50 p-5 rounded-[2rem] border border-slate-200 flex gap-4 relative group">
                        <button
                          onClick={() => {
                        ...
                        <div className="w-24 h-24 bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-300 hover:border-teal-400 hover:text-teal-500 cursor-pointer shrink-0 transition-colors">
                          <ImageIcon size={24} />
                        ...
                        <div className="flex-1 space-y-2">
                          <input
                            ...
                            value={member.name}
                            onChange={(e) => {
                              const newCounselors = [...teamContent.mainCampus.counselors];
                              newCounselors[idx].name = e.target.value;
                              setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, counselors: newCounselors } });
                            }}
                            placeholder="Name"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-black text-slate-800 focus:ring-2 focus:ring-teal-500 outline-none"
                          />
                          <input
                            type="text"
                            value={member.degree}
                            onChange={(e) => {
                              const newCounselors = [...teamContent.mainCampus.counselors];
                              newCounselors[idx].degree = e.target.value;
                              setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, counselors: newCounselors } });
                            }}
                            placeholder="Degree"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-1.5 text-[10px] font-bold text-teal-600 focus:ring-2 focus:ring-teal-500 outline-none"
                          />
                          <input
                            type="text"
                            value={member.dept}
                            onChange={(e) => {
                              const newCounselors = [...teamContent.mainCampus.counselors];
                              newCounselors[idx].dept = e.target.value;
                              setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, counselors: newCounselors } });
                            }}
                            placeholder="Department"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-1.5 text-[10px] font-medium text-slate-500 focus:ring-2 focus:ring-teal-500 outline-none"
                          />
                        </div>
                      </div>
                    ))}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {teamContent.mainCampus.coordinators.map((member, idx) => (
                      <div key={idx} className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2 relative group">
                        <button
                          onClick={() => {
                            const newItems = teamContent.mainCampus.coordinators.filter((_, i) => i !== idx);
                            setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, coordinators: newItems } });
                          }}
                          className="absolute -top-2 -right-2 w-5 h-5 bg-red-100 text-red-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-[10px] font-bold z-10"
                        >
                          ×
                        </button>
                        <div className="flex gap-2">
                          <div className="w-12 h-12 bg-white rounded-lg border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-300 shrink-0">
                            <ImageIcon size={16} />
                          </div>
                          <div className="flex-1 space-y-1">
                            ...
                            <input type="text" value={member.degree} onChange={(e) => {
                              const newItems = [...teamContent.mainCampus.coordinators];
                              newItems[idx].degree = e.target.value;
                              setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, coordinators: newItems } });
                            }} className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-[9px] font-bold text-teal-600 outline-none" />
                          </div>
                        </div>
                        <input type="text" value={member.dept} onChange={(e) => {
                          ...
                          setTeamContent({ ...teamContent, mainCampus: { ...teamContent.mainCampus, coordinators: newItems } });
                        }} className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-[9px] font-medium text-slate-500 outline-none" />
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <label className="block text-xs font-black text-slate-500 uppercase tracking-widest">Support Staff</label>
                    <button
                      onClick={() => {
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {teamContent.mainCampus.staff.map((member, idx) => (
                      <div key={idx} className="bg-slate-50 p-4 rounded-2xl border border-slate-200 flex gap-3 relative group">
                        <button
                          onClick={() => {
                        ...
                        <div className="w-16 h-16 bg-white rounded-xl border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-300 shrink-0">
                          <ImageIcon size={20} />
                        </div>
                        <div className="flex-1 space-y-1">
                          <input type="text" value={member.name} onChange={(e) => {
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  {teamContent.esuCampus.map((member, idx) => (
                    <div key={idx} className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2 relative group">
                      ...
                      <div className="w-full aspect-square bg-white rounded-xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-300">
                        <ImageIcon size={20} />
                        <span className="text-[8px] font-bold mt-1">Photo</span>
                      </div>
                      <input type="text" value={member.name} onChange={(e) => {
