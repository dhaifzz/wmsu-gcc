  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat p-4 sm:p-6"
      ...
      <motion.div 
        ...
        className="relative z-30 flex w-full max-w-[32rem] flex-col overflow-hidden rounded-[3rem] bg-white shadow-2xl p-10 lg:p-14"
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {!isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
                <div className="relative flex items-center group">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-[1.5rem] bg-slate-50 border border-slate-100 py-5 pl-14 pr-4 text-base font-bold text-slate-700 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all shadow-sm"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-4 rounded-full bg-emerald-900 py-5 text-base font-black text-white shadow-xl shadow-emerald-950/20 transition-all hover:-translate-y-1 hover:bg-emerald-800 active:translate-y-0 active:shadow-md"
                >
            ...
            >
              <div className="mx-auto mb-10 flex h-28 w-28 items-center justify-center rounded-[2.5rem] bg-emerald-50 text-emerald-600 shadow-inner">
              ...
              <button 
                ...
                className="w-full rounded-[1.5rem] bg-slate-100 py-5 text-base font-bold text-slate-600 transition-all hover:bg-slate-200"
              >
